...
[ ! -d wt-${WTV}-qtc-http ] && echo "No Project: wt-${WTV}-qtc-http" && exit -1
sed -i \
    ...
    wt-${WTV}-qtc-http/CMakeLists.txt
#mkdir -p wt-${WTV}-qtc-http/build/{CCMake-Debug,CCMake-MinSizeRel,CCMake-Profile,CCMake-Release,CCMake-RelWithDebInfo}
#ccmake -B wt-${WTV}-qtc-http/build/CCMake-Debug -S wt-${WTV}-qtc-http \
