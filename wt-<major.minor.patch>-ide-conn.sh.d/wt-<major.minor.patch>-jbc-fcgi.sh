...
[ ! -d wt-${WTV}-jbc-fcgi ] && echo "No Project: wt-${WTV}-jbc-fcgi" && exit -1
sed -i \
    ...
    wt-${WTV}-jbc-fcgi/CMakeLists.txt
mkdir -p wt-${WTV}-jbc-fcgi/build/{CCMake-Debug,CCMake-MinSizeRel,CCMake-Profile,CCMake-Release,CCMake-RelWithDebInfo}
ccmake -B wt-${WTV}-jbc-fcgi/build/CCMake-Debug -S wt-${WTV}-jbc-fcgi \
