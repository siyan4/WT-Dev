...
[ ! -d wt-${WTV}-qtc-fcgi ] && echo "No Project: wt-${WTV}-qtc-fcgi" && exit -1
sed -i \
    ...
    wt-${WTV}-qtc-fcgi/CMakeLists.txt
#mkdir -p wt-${WTV}-qtc-fcgi/build/{CCMake-Debug,CCMake-MinSizeRel,CCMake-Profile,CCMake-Release,CCMake-RelWithDebInfo}
#ccmake -B wt-${WTV}-qtc-fcgi/build/CCMake-Debug -S wt-${WTV}-qtc-fcgi \
